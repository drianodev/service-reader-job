package br.com.drianodev.serviceReaderJob.reader;

import java.util.ArrayList;
import java.util.List;

import br.com.drianodev.serviceReaderJob.domain.ResponseUser;
...
public class UserReader implements ItemReader<User> {
    ...
    private List<User> fetchUserDataFromAPI() {
        ResponseEntity<ResponseUser> response = restTemplate
                .getForEntity(String.format("https://randomuser.me/api/?page=%d&results=%d", page, pageSize), ResponseUser.class);

        List<User> usersData = response.getBody().getResults();
        return usersData;
    }
